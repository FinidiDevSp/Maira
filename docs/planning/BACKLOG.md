...
> ⚠️ **Vista renderizada** desde `items/` por `make render-planning`. No editar las listas a mano.
> El bloque "📍 Estado actual" sí lo mantiene Milton (memoria/docs) al cerrar cada tarea.
> Las ideas post-MVP viven en el [`BACKLOG.md` de la raíz](../../BACKLOG.md) (archivo de ideas, no operativo).
